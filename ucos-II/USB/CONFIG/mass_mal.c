...
* Return         : None
*******************************************************************************/
MAL_RESULT MAL_Init(uint8_t lun)
{ 
	switch (lun)
	{
		case 0:			    
...
* Return         : None
*******************************************************************************/
MAL_RESULT MAL_Write(uint8_t lun, uint32_t Memory_Offset, uint32_t *Writebuff, uint16_t Transfer_Length)
{
	u8 STA;
	switch (lun)
	{
...
*******************************************************************************/
MAL_RESULT MAL_Read(uint8_t lun, uint32_t Memory_Offset, uint32_t *Readbuff, uint16_t Transfer_Length)
{
	u8 STA;
	switch (lun)
	{
...
* Return         : None
*******************************************************************************/
MAL_RESULT MAL_GetStatus (uint8_t lun)
{
    switch(lun)
    {
    case 0:
